<?php
// Updated on 9/10/2013 2:27:00 PM
...
Class ClientProxy
{
	...
	public function ConstructWithAccountId($wsdl, $username, $password, $token, $accountId)
	{
	...
	public function ConstructWithAccountAndCustomerId($wsdl, $username, $password, $token, $accountId, $customerId)
	{
		$thisClient = new ClientProxy($wsdl);
